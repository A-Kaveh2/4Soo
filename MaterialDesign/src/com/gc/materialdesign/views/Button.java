...
public abstract class Button extends CustomView {
    ...
    boolean fixedRippleColor = false, fillWithRipple = false;
    ...
    public Button(Context context, AttributeSet attrs) {
        ...
        // Set Ripple Color
        // Color by resource
        rippleColor = attrs.getAttributeResourceValue(MATERIALDESIGNXML,
                "rippleColor", -1);
        if (rippleColor != -1) {
            setRippleColor(getResources().getColor(rippleColor));
            fixedRippleColor = true;
        } else {
    ...
    public void setFillWithRipple(boolean fillWithRipple) {
        this.fillWithRipple = fillWithRipple;
    }
}
