...
public class ActivityUserRegisterPageOne extends CharsooActivity  implements IWebserviceResponse{
    ...
    public void getResult(Object result) {
        ...
        Intent intent = new Intent(ActivityUserRegisterPageOne.this,ActivityMain.class);
    ...
    public void getError(Integer errorCode,String callerStringID) {
        progressDialog.dismiss();
        new DialogMessage(ActivityUserRegisterPageOne.this, ServerAnswer.getError(ActivityUserRegisterPageOne.this, errorCode, callerStringID + ">" + this.getLocalClassName())).show();
    }
    ...
    private void doRegisterUser(){
        ...
        if (tempStringTwo!=null){
            ...
            progressDialog.show();
            new RegisterUser(ActivityUserRegisterPageOne.this,user,ActivityUserRegisterPageOne.this).execute();
        }
    }
}
