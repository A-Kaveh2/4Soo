...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public static final String TAB_HOST_UNSELECTED_TEXT_COLOR="#B3E5FC";
    public static final String TAB_HOST_SELECTED_TAB_TEXT_COLOR="#FFFFFF";
...
//        get screen size
        ...
        textView.setLayoutParams(new ViewGroup.LayoutParams(measuredWidth/tabCount, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            // automatically popup soft keyboard for tab add text
//            if (position==1);
////                FragmentAddtext.getInstance().getEventListener().setEditTextFocus();
//            else
//                FragmentAddtext.getInstance().removeEditTextFocus();
