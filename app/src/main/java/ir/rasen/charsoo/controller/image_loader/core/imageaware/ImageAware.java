 ...
 *******************************************************************************/
package ir.rasen.charsoo.controller.image_loader.core.imageaware;
 ...
 * through {@link ir.rasen.charsoo.controller.image_loader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link ir.rasen.charsoo.controller.image_loader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain ir.rasen.charsoo.controller.image_loader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link ir.rasen.charsoo.controller.image_loader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain ir.rasen.charsoo.controller.image_loader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *Drawable) for empty Uri},
	 * {@linkplain ir.rasen.charsoo.controller.image_loader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *Drawable) on loading} or
	 * {@linkplain ir.rasen.charsoo.controller.image_loader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain ir.rasen.charsoo.controller.image_loader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link ir.rasen.charsoo.controller.image_loader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link ir.rasen.charsoo.controller.image_loader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
