...
public class URLs {
    ...
    //lcoal address
    //public static String MAIN_URL = "http://192.168.0.109:8080/bsn/";
    ...
    public static String SHARE_POST = MAIN_URL+"sharePost";
    ...
    public static String REQUEST_CANCEL_FRIENDSHIP = MAIN_URL+"requestCancelFriendship";
