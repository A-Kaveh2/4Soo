 ...
 *******************************************************************************/
package ir.rasen.charsoo.controller.image_loader.core.decode;
...
public class BaseImageDecoder implements ImageDecoder {
	 ...
	 *                       ir.rasen.charsoo.controller.image_loader.core.ImageLoaderConfiguration.Builder#writeDebugLogs()
	 ...
	 */
	@Override
	public Bitmap decode(ImageDecodingInfo decodingInfo) throws IOException, JSONException {
	...
	protected InputStream getImageStream(ImageDecodingInfo decodingInfo) throws IOException , JSONException{
	...
	protected InputStream resetStream(InputStream imageStream, ImageDecodingInfo decodingInfo) throws IOException,JSONException {
		try {
			imageStream.reset();
		} catch (IOException e) {
			IoUtils.closeSilently(imageStream);
