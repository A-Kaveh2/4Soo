...
public class SearchUser extends AsyncTask<Void, Void, ArrayList<BaseAdapterItem>> {
    ...
    public SearchUser(Context context,String searchText, int beforeThisId, int limitation, IWebserviceResponse delegate) {
            ...
            if (serverAnswer.getSuccessStatus()) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    list.add(new BaseAdapterItem(context.getResources(),jsonObject.getInt(Params.ID),
                            ...
                            jsonObject.getString(Params.USER_ID_INT_FOR_SearchUser)
                    ));
                }
                return list;
            }
